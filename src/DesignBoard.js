...
function DesignBoard(props) {
  return (
    <div className='flex flex-col justify-center w-full bg-gray-800 text-white'>
        ...
        <p className="mb-12 mx-auto">Design Board is an interior design web app that lets you visualize home decore and furnature selections from amazon.com.</p>
        <a className="hover:bg-indigo-600 hover:text-white shadow-lg rounded-lg py-6 px-12 mx-auto" href='https://github.com/93dannyp/93dannyp.github.io'>Visit the Repo</a>
