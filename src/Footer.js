...
function Footer(props) {
    return (
      <div className='flex flex-col items-center h-64 bg-gray-900 text-white px-4'>
        ...
        <a className="hover:bg-green-600 hover:text-white focus:outline-none focus:shadow-outline shadow-lg rounded-lg py-6 px-12 transition ease-in-out duration-700" href='https://github.com/danielperkinsii'>GitHub</a><br/>
        <a className="hover:bg-blue-500 hover:text-white focus:outline-none focus:shadow-outline shadow-lg rounded-lg py-6 px-12 transition ease-in-out duration-700" href='https://twitter.com/danielperkinsii'>Twitter</a><br/>
